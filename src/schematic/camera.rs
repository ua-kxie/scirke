/* 2d camera with panning and zooming */
use bevy::{
...
impl Plugin for CameraPlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(PreUpdate, (zoom, pan));
    }
}
...
fn pan(
    ...
    mut query: Query<(&SchematicCamera, &mut Transform, &OrthographicProjection)>,
