...
use bevy::{math::vec3, prelude::*, render::{mesh::{PrimitiveTopology, Indices::U16}, render_asset::RenderAssetUsages, view::NoFrustumCulling}, sprite::{MaterialMesh2dBundle, Mesh2dHandle}};
...
pub fn setup(
    ...
    let far_plane_depth = 1.0 - f32::EPSILON;
    let mesh = Mesh::new(
